        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create New Hostel Allocation</h3>
                ...
                <div class="card-body">
                    <form action="{{ route('admin.accommodation.allocation.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="bed_no" id="bed_no" class="form-control @error('bed_no') is-invalid @enderror" 
                                           value="{{ old('bed_no') }}" placeholder="e.g., A1, B2">
                                    @error('bed_no')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="monthly_fee" id="monthly_fee" class="form-control @error('monthly_fee') is-invalid @enderror" 
                                           value="{{ old('monthly_fee', 0) }}" min="0" step="0.01" required>
                                    @error('monthly_fee')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="security_deposit" id="security_deposit" class="form-control @error('security_deposit') is-invalid @enderror" 
                                           value="{{ old('security_deposit', 0) }}" min="0" step="0.01">
