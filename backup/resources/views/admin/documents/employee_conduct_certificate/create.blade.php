...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="bi bi-shield-check me-2 text-primary"></i> Create Conduct Certificate (Employee)</h4>
        <a href="{{ route('admin.documents.employee-conduct-certificate.index') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-left me-1"></i> Back to List
        </a>
    </div>

    <form method="POST" action="{{ route('admin.documents.employee-conduct-certificate.store') }}" class="needs-validation" novalidate>
        @csrf
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input class="form-control" name="ecc_number" placeholder="Auto/Manual">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" name="conduct" placeholder="e.g. Excellent / Good / Satisfactory">
                            </div>
                            <div class="col-12">
