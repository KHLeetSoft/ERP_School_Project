...
<div class="container-fluid">
    ...
    <div class="card mt-4 shadow-sm">
        <div class="card-header fw-bold">Recent Study Certificates</div>
                    ...
                    <tbody>
                        @forelse($recent as $r)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.documents.study-certificate.show', $r) }}" class="btn btn-sm btn-outline-secondary">View</a>
                                </td>
                            </tr>
                        @empty
