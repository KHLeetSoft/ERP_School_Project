...
@section('title','Edit Postal Dispatch')

@section('content')
<div class="card">
  <div class="card-header"><h4 class="mb-0">Edit Postal Dispatch</h4></div>
  <div class="card-body">
    <form action="{{ route('admin.office.dispatch.update', $item->id) }}" method="POST">
      @csrf @method('PUT')
      <div class="row mb-3">
        <label class="col-md-2 col-form-label">To Title</label>
        <div class="col-md-10"><input type="text" name="to_title" class="form-control" value="{{ old('to_title',$item->to_title) }}" required></div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-10"><input type="text" name="from_title" class="form-control" value="{{ old('from_title',$item->from_title) }}"></div>
      </div>
      <div class="row mb-3">
