...
<div class="container-fluid">
	<div class="card shadow-sm mb-4 border-0">
		<div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
			<h4 class="mb-0"><i class="bx bx-user-check me-2 text-primary"></i> Exam Attendance</h4>
			<div class="btn-group" role="group">
				<a href="{{ route('admin.exams.attendance.dashboard') }}" class="btn btn-info btn-sm"><i class="bx bx-bar-chart"></i> Dashboard</a>
				<a href="{{ route('admin.exams.attendance.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i> Create</a>
				<a href="{{ route('admin.exams.attendance.export') }}" class="btn btn-success btn-sm"><i class="fas fa-file-export me-1"></i> Export</a>
		...
		<div class="p-3">
			<div class="row g-3 mb-2">
				...
				<div class="col-md-3">
					...
					<input id="filterSubject" class="form-control" placeholder="Subject name">
				</div>
			</div>
			<div class="table-responsive">
				<table id="attendanceTable" class="table table-striped align-middle w-100">
	...
	<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header"><h5 class="modal-title">Import Exam Attendance</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
				<form action="{{ route('admin.exams.attendance.import') }}" method="POST" enctype="multipart/form-data">
					@csrf
...
$(function () {
	const table = $('#attendanceTable').DataTable({
		...
		serverSide: true,
		ajax: {
			url: "{{ route('admin.exams.attendance.index') }}",
			data: function(d){
		...
		columns: [
			...
			{data: 'attendance_status', name: 'attendance_status', render:(d)=> {
	...
	$('#filterExam, #filterClass, #filterStudent, #filterSubject').on('change keyup', function(){ table.ajax.reload(); });
