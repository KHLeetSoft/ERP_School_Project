...
<div class="container-fluid">
	<div class="card shadow-sm mb-4 border-0">
		<div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
			<h4 class="mb-0"><i class="bx bx-id-card me-2 text-primary"></i> Progress Cards</h4>
			<div class="btn-group" role="group">
				<a href="{{ route('admin.exams.progress-card.dashboard') }}" class="btn btn-info btn-sm"><i class="bx bx-bar-chart"></i> Dashboard</a>
				<a href="{{ route('admin.exams.progress-card.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i> Create</a>
				<a href="{{ route('admin.exams.progress-card.export') }}" class="btn btn-success btn-sm"><i class="fas fa-file-export me-1"></i> Export</a>
	...
	<div class="card shadow-sm border-0">
		<div class="p-3">
			...
			<div class="table-responsive">
				<table id="pcTable" class="table table-striped align-middle w-100">
	...
	<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header"><h5 class="modal-title">Import Progress Cards</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
				<form action="{{ route('admin.exams.progress-card.import') }}" method="POST" enctype="multipart/form-data">
					@csrf
...
<script>
$(function () {
	const table = $('#pcTable').DataTable({
		processing: true,
		serverSide: true,
		ajax: {
			url: "{{ route('admin.exams.progress-card.index') }}",
			data: function(d){
		...
		columns: [
			...
			{data: 'overall_percentage', name: 'overall_percentage'},
			{data: 'overall_grade', name: 'overall_grade'},
