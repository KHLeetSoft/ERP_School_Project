...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="bi bi-calendar-plus me-2 text-primary"></i> Create Exam</h4>
        <a href="{{ route('admin.exams.index') }}" class="btn btn-outline-secondary btn-sm"><i class="bi bi-arrow-left me-1"></i> Back to List</a>
    </div>

    <form method="POST" action="{{ route('admin.exams.store') }}" class="needs-validation" novalidate>
        @csrf
        <div class="row g-3">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input class="form-control" name="exam_type" placeholder="Unit/Term/Final">
                            </div>
                            <div class="col-md-3">
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2 mt-3">
                    <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i> Save Exam</button>
