        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <span>Joined {{ $teacher->joining_date ? $teacher->joining_date->format('M Y') : $user->created_at->format('M Y') }}</span>
                </div>
                <div class="mb-0">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" id="address" name="address" rows="3" 
                                      placeholder="Enter your address">{{ old('address', $teacher->address ?? '') }}</textarea>
                        </div>
                        
                        <div class="col-md-6 mb-3">
                            <label for="bio" class="form-label">Bio</label>
                            <textarea class="form-control" id="bio" name="bio" rows="3" 
                                      placeholder="Tell us about yourself">{{ old('bio', $teacher->bio ?? '') }}</textarea>
                        </div>
                    </div>
