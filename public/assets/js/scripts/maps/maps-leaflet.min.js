...
function getColor(e) {
    return 1e3 < e ? "#800026" : 500 < e ? "#BD0026" : 200 < e ? "#E31A1C" : 100 < e ? "#FC4E2A" : 50 < e ? "#FD8D3C" : 20 < e ? "#FEB24C" : 10 < e ? "#FED976" : "#FFEDA0";
}
function style(e) {
    return { fillColor: getColor(e.properties.density), weight: 2, opacity: 1, color: "white", dashArray: "3", fillOpacity: 0.7 };
}
$(function () {
    var e = $("#basic-map"),
    ...
    if (e.length) {
        ...
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(s);
    }
    if (t.length) {
        var y = L.map("circle-polygon-map").setView([51.5, -0.09], 12);
        L.marker([51.5, -0.09]).addTo(y),
            L.circle([51.508, -0.11], { color: "red", fillColor: "#f03", fillOpacity: 0.5, radius: 500 }).addTo(y),
            L.polygon([
                [51.509, -0.08],
                [51.503, -0.06],
                [51.51, -0.047],
            ]).addTo(y);
        L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(y);
    }
    if (o.length) {
        var d = L.map("draggable-marker-map").setView([48.817152, 2.455], 12);
        L.marker([48.817152, 2.455], { draggable: "true" }).addTo(d).bindPopup("<b>You're here!</b>").openPopup(),
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(d);
    }
    if (r.length) {
        var m = L.map("user-location-map").setView([42.35, -71.08], 10);
        m.locate({ setView: !0, maxZoom: 16 }),
            m.on("locationfound", onLocationFound),
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(m);
    }
    if (a.length) {
        ...
        L.marker([51.5, -0.09], { icon: c }).addTo(g),
            ...
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(g);
    }
    if (i.length) {
        var h = L.map("geojson-map").setView([44.2669, -72.576], 3);
        L.geoJson(n).addTo(h),
            L.geoJson(n, { style: style }).addTo(h),
            L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(h);
    }
    if (p.length) {
        var F = L.marker([39.61, -105.02]).bindPopup("This is Littleton, CO."),
            ...
            b = L.tileLayer("https://{s}.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }),
            T = L.tileLayer("http://tile.stamen.com/watercolor/{z}/{x}/{y}.jpg", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }),
            x = L.map("layer-control-map", { center: [39.73, -104.99], zoom: 10, layers: [b, M] }),
            k = { Street: b, Watercolor: T },
            C = { Cities: M };
        L.control.layers(k, C).addTo(x), L.tileLayer("https://c.tile.osm.org/{z}/{x}/{y}.png", { attribution: 'Map data &copy; <a href="https://www.openstreetmap.org/">OpenStreetMap</a>', maxZoom: 18 }).addTo(x);
    }
});
