        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="fas fa-edit"></i> Edit Resource: {{ $resource->title }}
                    </h3>
                ...
                <div class="card-body">
                    <form action="{{ route('teacher.resources.update', $resource) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control @error('type') is-invalid @enderror" 
                                                        ...
                                                        <option value="text" {{ old('type', $resource->type) == 'text' ? 'selected' : '' }}>Text</option>
                                                        ...
                                                        <option value="quiz" {{ old('type', $resource->type) == 'quiz' ? 'selected' : '' }}>Quiz</option>
                                ...
                                <div class="card" id="content-section">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            <p class="mb-2">
                                                <strong>File:</strong> {{ $resource->file_name }}<br>
                                                <strong>Size:</strong> {{ $resource->file_size_formatted }}<br>
                                                <strong>Type:</strong> {{ strtoupper($resource->file_extension) }}
                                            </p>
                                            <a href="{{ route('teacher.resources.download', $resource) }}" class="btn btn-sm btn-success">
                                        ...
                                        <div id="file-upload-section" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <small class="form-text text-muted">Maximum file size: 10MB. Leave empty to keep current file.</small>
                                                @error('file')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div id="url-section" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <input type="url" class="form-control @error('external_url') is-invalid @enderror" 
                                                       ...
                                                       placeholder="https://example.com" value="{{ old('external_url', $resource->external_url) }}">
                                                @error('external_url')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                        ...
                                        <div id="text-content-section" style="display: none;">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('content') is-invalid @enderror" 
                                                          ...
                                                          placeholder="Enter your content here...">{{ old('content', $resource->content) }}</textarea>
                                                @error('content')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('visibility') is-invalid @enderror" 
                                                ...
                                                <option value="private" {{ old('visibility', $resource->visibility) == 'private' ? 'selected' : '' }}>Private</option>
                                                <option value="shared" {{ old('visibility', $resource->visibility) == 'shared' ? 'selected' : '' }}>Shared</option>
                                                <option value="public" {{ old('visibility', $resource->visibility) == 'public' ? 'selected' : '' }}>Public</option>
                                            </select>
                                        ...
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="is_pinned" name="is_pinned" value="1" 
                                                   {{ old('is_pinned', $resource->is_pinned) ? 'checked' : '' }}>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="form-group text-right">
                                    ...
                                    <a href="{{ route('teacher.resources.show', $resource) }}" class="btn btn-info">
                                        <i class="fas fa-eye"></i> View
                                    </a>
