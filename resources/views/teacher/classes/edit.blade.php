...
@section('page-description', 'Update your teaching class details')
...
<div class="row">
    <div class="col-lg-8">
        <div class="card modern-card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="fas fa-edit me-2"></i>Edit Class</h5>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form method="POST" action="{{ route('teacher.classes.update', $class) }}">
                            ...
                            <select class="form-select @error('subject_id') is-invalid @enderror" 
                                ...
                                @foreach($subjects as $subject)
                                    <option value="{{ $subject->id }}" 
                                            @selected(old('subject_id', $class->subject_id) == $subject->id)>
                    ...
                    <div class="row">
                            ...
                            <select class="form-select @error('school_class_id') is-invalid @enderror" 
                                ...
                                @foreach($schoolClasses as $schoolClass)
                                    <option value="{{ $schoolClass->id }}" 
                                            @selected(old('school_class_id', $class->school_class_id) == $schoolClass->id)>
                                        {{ $schoolClass->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('room_number') is-invalid @enderror" 
                                   name="room_number" value="{{ old('room_number', $class->room_number) }}" 
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('start_time') is-invalid @enderror" 
                                   name="start_time" value="{{ old('start_time', $class->start_time) }}" required>
                            @error('start_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="time" class="form-control @error('end_time') is-invalid @enderror" 
                                   name="end_time" value="{{ old('end_time', $class->end_time) }}" required>
                            @error('end_time')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                                ...
                                <div class="col-md-3 col-sm-4 col-6 mb-2">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" 
                                               name="days[]" value="{{ $day }}" 
                                               id="day_{{ $loop->index }}"
                                               @checked(in_array($day, old('days', $class->days ?? [])))>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror" 
                                  ...
                                  placeholder="Optional description about this class">{{ old('description', $class->description) }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
    ...
    <div class="col-lg-4">
        <div class="card modern-card">
            <div class="card-header">
                <h6 class="card-title mb-0"><i class="fas fa-info-circle me-2"></i>Class Information</h6>
            </div>
            <div class="card-body">
                <div class="mb-3">
