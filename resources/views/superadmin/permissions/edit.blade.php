                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('module_name') is-invalid @enderror" 
                                            ...
                                            @foreach($modules as $key => $value)
                                                <option value="{{ $key }}" 
                                                        {{ (old('module_name', $currentModule) == $key) ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control @error('action_name') is-invalid @enderror" 
                                            ...
                                            @foreach($actions as $key => $value)
                                                <option value="{{ $key }}" 
                                                        {{ (old('action_name', $currentAction) == $key) ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="card-body">
                            <div class="permission-preview">
                                <div class="d-flex align-items-center mb-3">
                                    ...
                                    <div>
                                        <h6 class="mb-0" id="previewName">{{ ucfirst($currentModule) }} - {{ ucfirst($currentAction) }}</h6>
                                        <small class="text-muted" id="previewKey">{{ $permission->name }}</small>
                                    </div>
                                </div>
                                
                                <div class="mb-2">
                                    <span class="badge bg-info" id="previewModule">{{ ucfirst($currentModule) }}</span>
                                    <span class="badge bg-warning ms-1" id="previewAction">{{ ucfirst($currentAction) }}</span>
                                </div>
