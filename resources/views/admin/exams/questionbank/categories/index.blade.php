...
<div class="container-fluid">
	<div class="card shadow-sm mb-4 border-0">
		<div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
			<h4 class="mb-0"><i class="bx bx-category me-2 text-primary"></i> Question Categories</h4>
			<div class="btn-group" role="group">
				<a href="{{ route('admin.exams.question-bank.categories.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus me-1"></i> Create</a>
				<a href="{{ route('admin.exams.question-bank.categories.export') }}" class="btn btn-success btn-sm"><i class="fas fa-file-export me-1"></i> Export</a>
	...
	<div class="card shadow-sm border-0">
		<div class="p-3">
			<div class="table-responsive">
				<table id="catTable" class="table table-striped align-middle w-100">
	...
	<div class="modal fade" id="importModal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header"><h5 class="modal-title">Import Categories</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button></div>
				<form action="{{ route('admin.exams.question-bank.categories.import') }}" method="POST" enctype="multipart/form-data">
					@csrf
...
$(function () {
	const table = $('#catTable').DataTable({
		...
		serverSide: true,
		ajax: {
			url: "{{ route('admin.exams.question-bank.categories.index') }}",
		},
		dom:
