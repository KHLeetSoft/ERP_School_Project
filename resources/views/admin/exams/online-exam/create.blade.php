...
<div class="container-fluid">
    <div class="card shadow-sm mb-4 border-0">
        <div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
            <h4 class="mb-0"><i class="bx bx-plus me-2 text-primary"></i> Create Online Exam</h4>
    ...
    <form action="{{ route('admin.online-exam.store') }}" method="POST" id="onlineExamForm">
        @csrf
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3" id="negative_marks_container" style="display: none;">
                                ...
                                <input type="number" class="form-control" id="negative_marks" name="negative_marks" 
                                       value="{{ old('negative_marks', 0.25) }}" step="0.01" min="0">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            ...
                            <button type="submit" class="btn btn-success" name="status" value="published">
                                <i class="bx bx-check me-1"></i> Save & Publish
                            </button>
                            <a href="{{ route('admin.online-exam.index') }}" class="btn btn-secondary">
...
$(document).ready(function() {
    ...
    if ($('#negative_marking').is(':checked')) {
        $('#negative_marks_container').show();
    }
    ...
    function updateSelectedQuestions() {
        if (selectedQuestions.length === 0) {
            $('#selectedQuestionsContainer').hide();
            return;
        }
        
        $('#selectedQuestionsContainer').show();
        let html = '';
        let totalMarks = 0;
