...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Add Tracking Record</h3>
                <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.transport.tracking.store') }}">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror" 
                                        ...
                                        <option value="on_time" {{ old('status') == 'on_time' ? 'selected' : '' }}>On Time</option>
                                        <option value="delayed" {{ old('status') == 'delayed' ? 'selected' : '' }}>Delayed</option>
                                        <option value="early" {{ old('status') == 'early' ? 'selected' : '' }}>Early</option>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" 
                                           ...
                                           name="tracking_time" 
                                           id="tracking_time" 
                                           value="{{ old('tracking_time', date('H:i')) }}" 
                                           required>
                                    @error('tracking_time')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      id="notes" 
                                      rows="4" 
                                      placeholder="Enter any additional notes about this tracking record...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save"></i> Save Tracking Record
                            </button>
                            <a href="{{ route('admin.transport.tracking.index') }}" class="btn btn-secondary">
