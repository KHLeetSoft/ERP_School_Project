...
<div class="container-fluid">
    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="page-title">Create Leave Request</h3>
                <ul class="breadcrumb">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.hr.leave-management.store') }}" method="POST" id="leaveForm">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="total_days" id="total_days" class="form-control" 
                                           value="{{ old('total_days') }}" readonly step="0.5" min="0.5">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contact_during_leave" id="contact_during_leave" class="form-control @error('contact_during_leave') is-invalid @enderror" 
                                           value="{{ old('contact_during_leave') }}" placeholder="Emergency contact number">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address_during_leave" id="address_during_leave" class="form-control @error('address_during_leave') is-invalid @enderror" 
                                           value="{{ old('address_during_leave') }}" placeholder="Address where you'll be during leave">
                        ...
                        <div class="row" id="rejectionFields" style="display: none;">
                            <div class="col-md-12">
                                <div class="form-group">
