            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.accommodation.fees.show', $fee->id) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.accommodation.fees.update', $fee->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="allocation_id" id="allocation_id" class="form-control @error('allocation_id') is-invalid @enderror" required>
                                        ...
                                        <option value="{{ $allocation->id }}" {{ (old('allocation_id', $fee->allocation_id) == $allocation->id) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="amount" id="amount" class="form-control @error('amount') is-invalid @enderror" 
                                           value="{{ old('amount', $fee->amount) }}" min="0" step="0.01" required>
                                    @error('amount')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="month" id="month" class="form-control @error('month') is-invalid @enderror" required>
                                        ...
                                        @for($i = 1; $i <= 12; $i++)
                                        <option value="{{ $i }}" {{ (old('month', $fee->month) == $i) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="year" id="year" class="form-control @error('year') is-invalid @enderror" required>
                                        ...
                                        <option value="{{ $year }}" {{ (old('year', $fee->year) == $year) ? 'selected' : '' }}>
                                            {{ $year }}
                                        </option>
                                        @endfor
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="due_date" id="due_date" class="form-control @error('due_date') is-invalid @enderror" 
                                           value="{{ old('due_date', $fee->due_date ? $fee->due_date->format('Y-m-d') : '') }}" required>
                                    @error('due_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="payment_date" id="payment_date" class="form-control @error('payment_date') is-invalid @enderror" 
                                           value="{{ old('payment_date', $fee->payment_date ? $fee->payment_date->format('Y-m-d') : '') }}">
                                    @error('payment_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="payment_method" id="payment_method" class="form-control @error('payment_method') is-invalid @enderror">
                                        ...
                                        <option value="Other" {{ old('payment_method', $fee->payment_method) == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="transaction_id" id="transaction_id" class="form-control @error('transaction_id') is-invalid @enderror" 
                                           value="{{ old('transaction_id', $fee->transaction_id) }}" placeholder="Enter transaction reference">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="remarks" id="remarks" class="form-control @error('remarks') is-invalid @enderror" 
                                      rows="3" placeholder="Any additional remarks">{{ old('remarks', $fee->remarks) }}</textarea>
                            @error('remarks')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
