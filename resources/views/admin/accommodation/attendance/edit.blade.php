            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.accommodation.attendance.show', $attendance->id) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.accommodation.attendance.update', $attendance->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="allocation_id" id="allocation_id" class="form-control @error('allocation_id') is-invalid @enderror" required>
                                        ...
                                        <option value="{{ $allocation->id }}" {{ (old('allocation_id', $attendance->allocation_id) == $allocation->id) ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" id="date" class="form-control @error('date') is-invalid @enderror" 
                                           value="{{ old('date', $attendance->date ? $attendance->date->format('Y-m-d') : '') }}" required>
                                    @error('date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="remarks" id="remarks" class="form-control @error('remarks') is-invalid @enderror" 
                                           value="{{ old('remarks', $attendance->remarks) }}" placeholder="Any additional remarks">
                                    @error('remarks')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
