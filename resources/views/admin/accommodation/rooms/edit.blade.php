        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Edit Room - {{ $room->room_no }}</h3>
                    <div class="card-tools">
                        <a href="{{ route('admin.accommodation.rooms.show', $room->id) }}" class="btn btn-info">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.accommodation.rooms.update', $room->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="type" id="type" class="form-control @error('type') is-invalid @enderror" 
                                           value="{{ old('type', $room->type) }}" placeholder="e.g., Single, Double, Dorm">
                                    @error('type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select name="gender" id="gender" class="form-control @error('gender') is-invalid @enderror">
                                        ...
                                        <option value="Other" {{ old('gender', $room->gender) == 'Other' ? 'selected' : '' }}>Other</option>
                                    </select>
                                    @error('gender')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror" 
                                      rows="3" placeholder="Any additional notes about the room">{{ old('notes', $room->notes) }}</textarea>
                            @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
