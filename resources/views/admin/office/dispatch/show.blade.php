...
@section('title','Postal Dispatch Details')

@section('content')
<div class="card">
  <div class="card-header d-flex justify-content-between align-items-center">
    <h4 class="mb-0">Postal Dispatch Details</h4>
    <a href="{{ route('admin.office.dispatch.index') }}" class="btn btn-secondary btn-sm">Back</a>
  </div>
  <div class="card-body">
