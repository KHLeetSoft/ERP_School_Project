...
@section('title', 'Add Call Log')

@section('content')
<div class="container-fluid">
    <!-- Page Header -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Add New Call Log</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.office.calllogs.store') }}" method="POST">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('caller_name') is-invalid @enderror" 
                                   id="caller_name" name="caller_name" value="{{ old('caller_name') }}" required>
                            @error('caller_name')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('purpose') is-invalid @enderror" id="purpose" name="purpose">
                                ...
                                <option value="Inquiry" {{ old('purpose') == 'Inquiry' ? 'selected' : '' }}>Inquiry</option>
                                <option value="Complaint" {{ old('purpose') == 'Complaint' ? 'selected' : '' }}>Complaint</option>
                                <option value="Support" {{ old('purpose') == 'Support' ? 'selected' : '' }}>Support</option>
                                <option value="General" {{ old('purpose') == 'General' ? 'selected' : '' }}>General</option>
                                <option value="Admission" {{ old('purpose') == 'Admission' ? 'selected' : '' }}>Admission</option>
                                <option value="Fee" {{ old('purpose') == 'Fee' ? 'selected' : '' }}>Fee</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control @error('note') is-invalid @enderror" 
                              ...
                              placeholder="Enter any additional notes about the call...">{{ old('note') }}</textarea>
                    @error('note')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
