...
@section('title','Add Postal Receive')

@section('content')
<div class="card">
  <div class="card-header"><h4 class="mb-0">Add Postal Receive</h4></div>
  <div class="card-body">
    <form action="{{ route('admin.office.receive.store') }}" method="POST">
      @csrf
      <div class="row mb-3">
        <label class="col-md-2 col-form-label">From Title</label>
        <div class="col-md-10"><input type="text" name="from_title" class="form-control" required></div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-md-10"><input type="text" name="to_title" class="form-control"></div>
      </div>
      <div class="row mb-3">
