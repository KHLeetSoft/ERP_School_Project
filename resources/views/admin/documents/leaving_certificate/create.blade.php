...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0"><i class="bi bi-exclamation-octagon me-2 text-primary"></i> Create Leaving Certificate</h4>
        <a href="{{ route('admin.documents.leaving-certificate.index') }}" class="btn btn-outline-secondary btn-sm">
            <i class="bi bi-arrow-left me-1"></i> Back to List
        </a>
    </div>

    <form method="POST" action="{{ route('admin.documents.leaving-certificate.store') }}" class="needs-validation" novalidate>
        @csrf
                    ...
                    <div class="card-body">
                        <div class="row g-3">
                            <div class="col-md-3">
                                ...
                                <input class="form-control" name="lc_number" placeholder="Auto/Manual">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" name="reason_for_leaving" placeholder="e.g. Family relocation">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Conduct</label>
                                <input class="form-control" name="conduct" placeholder="e.g. Good / Very Good">
                            </div>
                            <div class="col-12">
