...
<div class="container">
    ...
    <form method="POST" action="{{ route('admin.academic.calendar.store') }}">
        @csrf
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">Start Time</label><input type="datetime-local" class="form-control" name="start_time"></div>
