...
class User extends Authenticatable
{
    ...
    public function managedSchool()
    {
        ...
        {
            // Get all permissions through the user's roles
        ...
        {
            return $this->permissions()->where('name', $permissionKey)->exists();
        }

        public function hasModulePermission($moduleName, $actionName)
        {
